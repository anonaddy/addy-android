...
class ManageAliasActivity : BaseActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        InsetUtils.applyBottomInset(binding.activityManageAliasLL1)
    ...
    private fun setOnClickListeners() {
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasActiveSwitchLayout.setOnLayoutClickedListener {
            forceSwitch = true
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasWatchSwitchLayout.setOnLayoutClickedListener {
            forceSwitch = true
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasLimitAttachedRecipientsSwitchLayout.setOnLayoutClickedListener {
            forceSwitch = true
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasDelete.setOnLayoutClickedListener { deleteAlias() }

        binding.activityManageAliasGeneralActions.activityManageAliasForget.setOnLayoutClickedListener { forgetAlias() }

        binding.activityManageAliasGeneralActions.activityManageAliasRestore.setOnLayoutClickedListener { restoreAlias() }
    ...
    override fun bulkRecipientsEdited(recipientIds: ArrayList<String>) {
        // Not used in single alias management
    }
    ...
    private fun setChart(forwarded: Float, replied: Float, blocked: Float, sent: Float) {
        ...
        val section1 = DonutSection(
            name = binding.activityManageAliasChart.context.resources.getQuantityString(R.plurals.d_forwarded, forwarded.toInt(), forwarded.toInt()),
        ...
        if (replied > 0) {
            val section2 = DonutSection(
                name = binding.activityManageAliasChart.context.resources.getQuantityString(R.plurals.d_replied, replied.toInt(), replied.toInt()),
        ...
        if (sent > 0) {
            val section3 = DonutSection(
                name = binding.activityManageAliasChart.context.resources.getQuantityString(R.plurals.d_sent, sent.toInt(), sent.toInt()),
        ...
        if (blocked > 0) {
            val section4 = DonutSection(
                name = binding.activityManageAliasChart.context.resources.getQuantityString(R.plurals.d_blocked, blocked.toInt(), blocked.toInt()),
        ...
        binding.activityManageAliasForwardedCount.text = this.resources.getQuantityString(R.plurals.d_forwarded, forwarded.toInt(), forwarded.toInt())
        binding.activityManageAliasRepliesBlockedCount.text = this.resources.getQuantityString(R.plurals.d_blocked, blocked.toInt(), blocked.toInt())
        binding.activityManageAliasSentCount.text = this.resources.getQuantityString(R.plurals.d_sent, sent.toInt(), sent.toInt())
        binding.activityManageAliasRepliedCount.text = this.resources.getQuantityString(R.plurals.d_replied, replied.toInt(), replied.toInt())
    }

    private fun setOnSwitchChangeListeners() {
        binding.activityManageAliasGeneralActions.activityManageAliasActiveSwitchLayout.setOnSwitchCheckedChangedListener { compoundButton, checked -> // Using forceswitch can toggle onCheckedChangeListener programmatically without having to press the actual switch
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasWatchSwitchLayout.setOnSwitchCheckedChangedListener { compoundButton, checked ->
        ...
        binding.activityManageAliasGeneralActions.activityManageAliasLimitAttachedRecipientsSwitchLayout.setOnSwitchCheckedChangedListener { compoundButton, checked -> // Using forceswitch can toggle onCheckedChangeListener programmatically without having to press the actual switch
            if (compoundButton.isPressed || forceSwitch) {
    ...
    private suspend fun deactivateAlias() {
        val result = viewModel.deactivateAlias(this@ManageAliasActivity.alias!!.id)
    ...
    private suspend fun activateAlias() {
        val result = viewModel.activateAlias(this@ManageAliasActivity.alias!!.id)
        binding.activityManageAliasGeneralActions.activityManageAliasActiveSwitchLayout.showProgressBar(false)
        if (result is NetworkResult.Success) {
    ...
    private suspend fun unpinAlias() {
        ...
        val result = viewModel.unpinAlias(this@ManageAliasActivity.alias!!.id)
        binding.activityManageAliasGeneralActions.activityManageAliasActiveSwitchLayout.showProgressBar(false)
    ...
    private suspend fun pinAlias() {
        binding.activityManageAliasToolbar.customToolbarOneHandedActionProgressbar.visibility = View.VISIBLE
        val result = viewModel.pinAlias(this@ManageAliasActivity.alias!!.id)
        binding.activityManageAliasToolbar.customToolbarOneHandedActionProgressbar.visibility = View.GONE
        if (result is NetworkResult.Success) {
            this.alias = result.data
            shouldRefreshOnFinish = true
    ...
    private suspend fun disableAttachedRecipientsOnly() {
        val result = viewModel.deactivateAttachedRecipientsOnly(this@ManageAliasActivity.alias!!.id)
    ...
    private suspend fun enableAttachedRecipientsOnly() {
        val result = viewModel.activateAttachedRecipientsOnly(this@ManageAliasActivity.alias!!.id)
        binding.activityManageAliasGeneralActions.activityManageAliasLimitAttachedRecipientsSwitchLayout.showProgressBar(false)
        if (result is NetworkResult.Success) {
            this.alias = result.data
            shouldRefreshOnFinish = true
    ...
    private suspend fun deleteAliasHttpRequest(id: String, context: Context) {
        val result = viewModel.deleteAlias(id)
        if (result is NetworkResult.Success) {
    ...
    private suspend fun forgetAliasHttpRequest(id: String, context: Context) {
        val result = viewModel.forgetAlias(id)
        if (result is NetworkResult.Success) {
    ...
    private suspend fun restoreAliasHttpRequest(id: String, context: Context) {
        val result = viewModel.restoreAlias(id)
        if (result is NetworkResult.Success) {
    ...
    private suspend fun getAliasInfo(id: String) {
        val result = viewModel.getAlias(id)
        if (result is NetworkResult.Success) {
            // Triggers updateUi
            this.alias = result.data
        } else {
