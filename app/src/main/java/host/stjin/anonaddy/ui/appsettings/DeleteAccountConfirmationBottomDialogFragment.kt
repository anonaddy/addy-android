...
class DeleteAccountConfirmationBottomDialogFragment : BaseBottomSheetDialogFragment() {
        ...
        override fun run() {
            ...
            if (secondsRemaining == 0) {
                ...
                binding.bsDeleteAccountConfirmationButton.text =
                    this@DeleteAccountConfirmationBottomDialogFragment.resources.getString(R.string.delete_account)
                binding.bsDeleteAccountConfirmationButton.setOnClickListener {
                    deleteAccountConfirmationDialog()
                }
            } else {
                binding.bsDeleteAccountConfirmationButton.text =
                    this@DeleteAccountConfirmationBottomDialogFragment.resources.getString(R.string.delete_account_countdown, secondsRemaining)
    ...
    companion object {
        fun newInstance(): DeleteAccountConfirmationBottomDialogFragment {
            return DeleteAccountConfirmationBottomDialogFragment()
        }
    }
}
