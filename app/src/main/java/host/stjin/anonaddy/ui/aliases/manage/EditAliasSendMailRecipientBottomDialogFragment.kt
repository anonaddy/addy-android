...
class EditAliasSendMailRecipientBottomDialogFragment : BaseBottomSheetDialogFragment(), View.OnClickListener {
    private var aliasEmail: String? = null

    private var listener: AddEditAliasSendMailRecipientBottomDialogListener? = null
    ...
    override fun onCreateView(
        ...
        listener = (parentFragment as? AddEditAliasSendMailRecipientBottomDialogListener) ?: (activity as? AddEditAliasSendMailRecipientBottomDialogListener)
    ...
    companion object {
        ...
        fun newInstance(aliasEmail: String?): EditAliasSendMailRecipientBottomDialogFragment {
            return EditAliasSendMailRecipientBottomDialogFragment().apply {
